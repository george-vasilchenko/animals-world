...
public class GameManager : MonoBehaviour
{
   ...
   private void Start()
   {
      ...
      #endregion Basic Information Initialization
      ...
      #endregion Text Field Initialization
      ...
      #endregion DropDown Initialization
   ...
   private void InitUI()
   {
      ...
      GetButton("BuyButton").onClick.AddListener(() =>
      {
         ...
         StoreService.Purchase(prodcutId, "{\"AnyKeyYouWant:\" : \"AnyValueYouWant\"}", purchaseListener);
      });
      ...
      GetButton("BuyConsumeButton").onClick.AddListener(() =>
      {
         ...
         StoreService.Purchase(prodcutId, "buy and consume developer payload", purchaseListener);
      });
      ...
      #endregion Button Initialization
   }
   ...
   /// <summary>Purchase Listener.</summary>
